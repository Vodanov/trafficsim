...
static std::unordered_map<TileType, Direction> tileToValue{
    ...
    {TileType::ROAD_UP_LEFT_RIGHT, Direction::UP | Direction::LEFT | Direction::RIGHT},
    {TileType::ROAD_UP_LEFT_DOWN, Direction::UP | Direction::LEFT | Direction::DOWN},
    {TileType::ROAD_UP_RIGHT_DOWN, Direction::UP | Direction::RIGHT | Direction::DOWN},
    {TileType::ROAD_LEFT_DOWN_RIGHT, Direction::LEFT | Direction::DOWN | Direction::RIGHT},
    {TileType::ROAD_CROSS, Direction::UP | Direction::DOWN | Direction::LEFT | Direction::RIGHT},
